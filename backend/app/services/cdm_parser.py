...
def parse_cdm_json(payload: dict) -> dict:
    ...
    primary_norad_id = payload.get("SAT_1_ID") or payload.get(
        "SAT1_NORAD_CAT_ID") or payload.get("SAT1_ID")
    secondary_norad_id = payload.get("SAT_2_ID") or payload.get(
        "SAT2_NORAD_CAT_ID") or payload.get("SAT2_ID")

...
def compute_gmst(dt: datetime) -> float:
    # Julian date
    jd = dt.toordinal() + 1721425.5 + dt.hour / 24.0 + dt.minute / 1440.0 + dt.second / 86400.0 + dt.microsecond / 86400000000.0
...
def propagate_tle(line1: str, line2: str, dt: datetime) -> Optional[Dict]:
    ...
    try:
        ...
        now_fr = (dt.hour * 3600 + dt.minute * 60 + dt.second + dt.microsecond / 1e6) / 86400.0
